  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-12">
      ...
      <form className="mt-6 flex flex-wrap gap-3" method="get">
        <select name="category" defaultValue={category ?? ""} className="border rounded px-2 py-1">
        ...
        <select name="equipment" defaultValue={equipment ?? ""} className="border rounded px-2 py-1">
        ...
        <select name="targetMuscle" defaultValue={targetMuscle ?? ""} className="border rounded px-2 py-1">
